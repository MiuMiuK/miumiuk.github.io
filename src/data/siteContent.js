...
export const projects = [
  {
    ...
    coverMeta: '2023-2025 / 完整研究案例 / 交互设计主导',
    coverSummary: '面向研发协作场景的信息结构与配置体验优化。',
    coverTags: ['问题定义', '用户研究', '方案设计', '可用性验证'],
    coverSummaryLineHeight: '55px',
    coverTopOffset: '149.5px',
  ...
  },
  {
    ...
    coverMeta: '2025-2026 / B端 AI 产品 / 交互设计',
    coverSummary:
      '让 AI 真正嵌入研发管理流程——从感知上下文、调用工具，到将结果回传业务系统，而不只是一个聊天窗口。',
    coverTags: [],
    coverSummaryLineHeight: '40px',
    coverTopOffset: '166px',
    category: 'AI 智能体',
    year: '2025-2026',
    client: 'ONES',
