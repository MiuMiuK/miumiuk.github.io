...
export default function Navbar({ brand, onNavigate, activeItem = null }) {
  ...
  return (
    <nav className="fixed left-0 top-0 z-50 flex w-full items-center justify-between border-b border-black/10 bg-white/95 px-5 py-5 backdrop-blur md:px-16 md:py-7">
      <button
        type="button"
